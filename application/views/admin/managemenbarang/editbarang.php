...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?= base_url('admin/managemenbarang'); ?>">Managemen Barang</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 md-2 form-group">
                        ...
                        <select class="custom-select" name="satuan">
                            ...
                            <option value="Kit" <?php if ($databarang['satuan'] == 'Kit') {
                                                        echo "selected";
                                                    } ?>>Kit</option>
                            <option value="Test" <?php if ($databarang['satuan'] == 'Test') {
                                                            echo "selected";
                                                        } ?>>Test</option>
                            <option value="Vial" <?php if ($databarang['satuan'] == 'Vial') {
                                                        echo "selected";
                                                    } ?>>Vial</option>
                            <option value="Botol" <?php if ($databarang['satuan'] == 'Botol') {
                                                        echo "selected";
                                                    } ?>>Botol</option>
                            <option value="Buah" <?php if ($databarang['satuan'] == 'Buah') {
                                                        echo "selected";
                                                    } ?>>Buah</option>
                            <option value="Buku" <?php if ($databarang['satuan'] == 'Buku') {
                                                        echo "selected";
                                                    } ?>>Buku</option>
                        </select>
                    </div>
