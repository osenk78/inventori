...
<div class="col-lg-8 mx-auto">
    <div class="card shadow mb-4">
            ...
            <form method="post" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="id_user" name="id_user" value="<?= $pengguna['id_user']; ?>" readonly hidden>
        ...
        <div class="card-footer text-md-right">
            <a href="<?= base_url('pengguna/permintaanbarang'); ?>" class="btn btn-secondary">Batal</a>
