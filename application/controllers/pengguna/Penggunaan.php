...
class Penggunaan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('pengguna/penggunaan/datapenggunaan', $data);
    ...
    public function tambah()
    {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if ($query == "sukses") {
                ...
                redirect('pengguna/penggunaan/', 'refresh');
            }
        } else {
        ...
        $this->load->view('header', $data);
        $this->load->view('pengguna/navbar', $data);
        $this->load->view('pengguna/penggunaan/tambahdata', $data);
        $this->load->view('footer');
    }
    ...
    public function detail($id_penggunaan)
    {
        ...
        $this->load->view('header', $data);
        $this->load->view('pengguna/navbar', $data);
        $this->load->view('pengguna/penggunaan/detailpenggunaan', $data);
        $this->load->view('footer');
    }
    ...
    public function tambahdetail($id_penggunaan)
    {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if ($query == "sukses") {
                ...
                redirect('pengguna/penggunaan/detail/' . $id_penggunaan, 'refresh');
            } elseif ($query == "gagal") {
        ...
        $this->load->view('header', $data);
        $this->load->view('pengguna/navbar', $data);
        $this->load->view('pengguna/penggunaan/tambahdetail', $data);
        $this->load->view('footer');
    }
    ...
    public function cetak($id_penggunaan)
    {
        ...
        $this->load->view('pengguna/penggunaan/cetakpenggunaan', $data);
    }
