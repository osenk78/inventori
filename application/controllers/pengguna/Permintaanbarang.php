...
class Permintaanbarang extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('pengguna/permintaanbarang/dataperbar', $data);
    ...
    public function tambah()
    {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            //tampilkan pengguna/permintaanbarang/index
            $this->session->set_flashdata('pesan', 'Data berhasil ditambah!');
            redirect('pengguna/permintaanbarang', 'refresh');
        }
        // selain itu gagal  
        else {
        ...
        $this->load->view('header', $data);
        $this->load->view('pengguna/navbar', $data);
        $this->load->view('pengguna/permintaanbarang/tambahperbar', $data);
        $this->load->view('footer');
    }
    ...
    public function detail($id_permintaanbarang)
    {
        ...
        $this->load->view('header', $data);
        $this->load->view('pengguna/navbar', $data);
        $this->load->view('pengguna/permintaanbarang/detailperbar', $data);
        $this->load->view('footer');
    }
    ...
    public function tambahdetail($id_permintaanbarang)
    {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if ($query == "sukses") {
                $this->session->set_flashdata('pesan', 'Data berhasil ditambah!');
                redirect('pengguna/permintaanbarang/detail/' . $id_permintaanbarang, 'refresh');
            } elseif ($query == "gagal") {
        ...
        $this->load->view('header', $data);
        $this->load->view('pengguna/navbar', $data);
        $this->load->view('pengguna/permintaanbarang/tambahdetail', $data);
        $this->load->view('footer');
    }
