...
class Managemenbarang extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/managemenbarang/databarang', $data);
    ...
    public function tambah()
    {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            redirect('admin/managemenbarang', 'refresh');
        }
        // selain itu gagal  
        else {
        ...
        $this->load->view('header', $data);
        $this->load->view('admin/navbar', $data);
        $this->load->view('admin/managemenbarang/tambahbarang', $data);
        $this->load->view('footer');
    }
    ...
    public function detail($id_barang)
    {
        ...
        $this->load->view('header', $data);
        $this->load->view('admin/navbar', $data);
        $this->load->view('admin/managemenbarang/detailbarang', $data);
        $this->load->view('footer');
    }
    ...
    public function ubah($id_barang)
    {
        ...
        $this->load->view('header', $data);
        $this->load->view('admin/navbar', $data);
        $this->load->view('admin/managemenbarang/editbarang', $data);
        $this->load->view('footer');
    }
